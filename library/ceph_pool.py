...
def run_module():
    module_args = dict(
        ...
        state=dict(type='str', required=True, choices=['present', 'absent', 'list']),  # noqa E501
    ...
    if state == "present":
        ...
        rc, cmd, out, err = exec_commands(module, remove_pool(cluster, name, user, user_key, container_image=container_image))  # noqa E501
