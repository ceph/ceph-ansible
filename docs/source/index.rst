...
===========
    ...
    # Review and chagne parameters under ``inventory/mycluster/group_vars``
    cat inventory/mycluster/group_vars/all.yml

    # Deploy ceph-ansible with Ansible Playbook
    ansible-playbook -i inventory/mycluster/hosts.ini site.yml.sample
